...
np.save('Control_Compiled_Data_L_ch1.npy', FinalData_ch1)
...
np.save('Control_Compiled_Data_L_ch2.npy', FinalData_ch2)
...
np.save('Control_Compiled_Data_L_ch3.npy', FinalData_ch3)
